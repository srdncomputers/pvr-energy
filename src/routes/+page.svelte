    ...
    <div class="about-grid">
      <div class="about-img-wrap">
        ...
        <div class="about-img-badge">
          ...
          <div class="aib-label">Years Serving<br/>Bangalore</div>
        </div>
      </div>
      <div class="about-content">
        ...
        <p>We specialise in solar rooftop installations across <strong>Electronic City, Anekal, Attibele, Jigani, Hosa Road</strong> and the Bangalore Rural district — areas where solar potential is high and electricity costs are significant.</p>
        ...
        <div class="about-highlights">
          <div class="ah-item">
            ...
            <div><strong>BESCOM Empanelled</strong><br/><small>Approved vendor for net metering</small></div>
          </div>
          <div class="ah-item">
            <span class="ah-icon">💰</span>
          ...
          <div class="ah-item">
            <span class="ah-icon">🔧</span>
            <div><strong>End-to-End Service</strong><br/><small>Survey → Install → AMC</small></div>
          </div>
          <div class="ah-item">
            <span class="ah-icon">📍</span>
  ...
  <div class="container">
    <div class="cta-inner">
      ...
      <div class="cta-actions">
        ...
        <a href="mailto:info@pvrenergysolutions.in" class="cta-email">
          📧 info@pvrenergysolutions.in
        </a>
      </div>
    </div>
    ...
    <div class="contact-grid">
      <div class="contact-info">
        ...
        <div class="ci-item">
          ...
          <div>
            <strong>Email</strong>
            <p><a href="mailto:info@pvrenergysolutions.in">info@pvrenergysolutions.in</a></p>
          </div>
        </div>
        <div class="ci-item">
          <div class="ci-icon">🕐</div>
          <div>
            ...
            <p>Monday – Saturday: 9:00 AM – 6:00 PM<br/>Sunday: On appointment only</p>
          </div>
        </div>
      </div>
        ...
        <form class="contact-form" on:submit|preventDefault={(e) => { const fd = new FormData(e.target); whatsapp(`Name: ${fd.get('name')}\nPhone: ${fd.get('phone')}\nMessage: ${fd.get('message')}`); }}>
          ...
          <div class="cf-group">
            ...
            <select id="service" name="service">
              ...
              <option>UPS / Power Backup</option>
            </select>
          </div>
          <div class="cf-group">
    ...
    <div class="footer-grid">
      ...
      <div class="footer-col">
        ...
        <ul>
          ...
          <li>Jigani</li>
          <li>Hosa Road</li>
          <li>Bangalore Rural District</li>
        </ul>
      </div>
      <div class="footer-col">
        <h4>Contact</h4>
...
<style>
  ...
  .nav-admin{background:var(--border);border:none;width:34px;height:34px;border-radius:8px;font-size:15px;display:flex;align-items:center;justify-content:center;transition:background 0.15s;}
  .nav-admin:hover{background:#e5e7eb;}
  ...
  .admin-login input:focus{border-color:var(--orange);}
  ...
  .admin-url-section input:focus{border-color:var(--orange);}
  ...
  .hero-content > p{font-size:17px;color:#cbd5e1;margin-bottom:32px;}
